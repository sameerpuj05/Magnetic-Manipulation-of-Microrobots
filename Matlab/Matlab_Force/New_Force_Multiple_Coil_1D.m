...
gravity = 9.8 ; %m/s^2
Coeff_of_Fric = 0.424;
Force_cy = Coeff_of_Fric * mass_cy * gravity; %N (0.38mN)
...
F_xx_2 = vol_cy * Magentization* (df_xx + df_xx_n + df_xx_2_n + df_xx_2)/m0;
F_xx_3 = vol_cy * Magentization* (df_xx + df_xx_n + df_xx_2_n + df_xx_2 + df_xx_3 + df_xx_3_n )/m0;
F_xx_4 = vol_cy * Magentization* (df_xx + df_xx_n + df_xx_2_n + df_xx_2 + df_xx_3 + df_xx_3_n + df_xx_4 + df_xx_4_n)/m0;
F_xx_5 = vol_cy * Magentization* (df_xx + df_xx_n + df_xx_2_n + df_xx_2 + df_xx_3 + df_xx_3_n + df_xx_4 + df_xx_4_n + df_xx_5 + df_xx_5_n)/m0;

F_xz_1 = vol_cy * Magentization* (df_xz + df_xz_n)/m0;
F_xz_2 = vol_cy * Magentization* (df_xz + df_xz_n + df_xz_2_n + df_xz_2)/m0;
F_xz_3 = vol_cy * Magentization* (df_xz + df_xz_n + df_xz_2_n + df_xz_2 + df_xz_3 + df_xz_3_n )/m0;
F_xz_4 = vol_cy * Magentization* (df_xz + df_xz_n + df_xz_2_n + df_xz_2 + df_xz_3 + df_xz_3_n + df_xz_4 + df_xz_4_n)/m0;  
F_xz_5 = vol_cy * Magentization* (df_xz + df_xz_n + df_xz_2_n + df_xz_2 + df_xz_3 + df_xz_3_n + df_xz_4 + df_xz_4_n + df_xz_5 + df_xz_5_n)/m0;  
%--------%--------%--------%--------%--------%--------%--------%----------
% Force along Y - axis
%-%--------%--------%--------%--------%--------%--------%--------%--------
...
%-%--------%--------%--------%--------%--------%--------%--------%--------
p = 34;     %also works for a height of 1mm when we put p = 1
figure
plot(c*1000,F_xz_1(p,:)*1000,':r')
hold on
% plot(c,F_xx_1(p,:), 'g') 
% plot(c,F_xx_2(p,:),'-k', 'LineWidth',1)
% plot(c,F_xx_3(p,:),'-b', 'LineWidth',2)
% plot(c,F_xx_4(p,:),':m', 'LineWidth',3)
% plot(c,F_xx_5(p,:),'y', 'LineWidth',4)
plot(c*1000,F_xz_2(p,:)*1000,'g')
plot(c*1000,F_xz_3(p,:)*1000,'-k')
plot(c*1000,F_xz_4(p,:)*1000,'.-b')
plot(c*1000,F_xz_5(p,:)*1000,':m')
line([-2 2],[Force_cy*1000 Force_cy*1000],'linewidth',3,'color','cyan')
line([a_yn_1*1000 a_yn_1*1000],[-1 1],'linewidth',10,'color','g');
line([a_yp_1*1000,a_yp_1*1000],[-1e-3*1000 1e-3*1000],'linewidth',10,'color','g');
line([a_xn_2*1000 a_xn_2*1000],[-1e-3*1000 1e-3*1000],'linewidth',10,'color','g');
line([a_xp_2*1000,a_xp_2*1000],[-1e-3*1000 1e-3*1000],'linewidth',10,'color','g');
line([a_yn_3*1000 a_yn_3*1000],[-1e-3*1000 1e-3*1000],'linewidth',10,'color','g');
line([a_yp_3*1000,a_yp_3*1000],[-1e-3*1000 1e-3*1000],'linewidth',10,'color','g');
line([a_yn_4*1000 a_yn_4*1000],[-1e-3*1000 1e-3*1000],'linewidth',10,'color','g');
line([a_yp_4*1000,a_yp_4*1000],[-1e-3*1000 1e-3*1000],'linewidth',10,'color','g');
line([a_yn_5*1000 a_yn_5*1000],[-1e-3*1000 1e-3*1000],'linewidth',10,'color','g');
line([a_yp_5*1000,a_yp_5*1000],[-1e-3*1000 1e-3*1000],'linewidth',10,'color','g');
% legend('one coil', 'three coils', 'five coils', 'Frictional_force')
% legend('F_xx_1', 'F_xz_1', 'F_xx_2', 'F_xz_2')
xlabel("Distance from Center of wire(mm) at Current = 0.2 A")
...
% line([a_xn_2 a_xn_2],[-1e-3 1e-3],'linewidth',10,'color','g');
% line([a_xp_2,a_xp_2],[-1e-3 1e-3],'linewidth',10,'color','g');
% line([a_yn_3 a_yn_3],[-1e-3 1e-3],'linewidth',10,'color','g');
% line([a_yp_3,a_yp_3],[-1e-3 1e-3],'linewidth',10,'color','g');
% line([a_yn_4 a_yn_4],[-1e-3 1e-3],'linewidth',10,'color','g');
% line([a_yp_4,a_yp_4],[-1e-3 1e-3],'linewidth',10,'color','g');
% line([a_yn_5 a_yn_5],[-1e-3 1e-3],'linewidth',10,'color','g');
% line([a_yp_5,a_yp_5],[-1e-3 1e-3],'linewidth',10,'color','g');
