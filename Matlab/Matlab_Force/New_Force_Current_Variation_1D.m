...
% Constants 
I1 = -.2;       %Current flowing in the wire
I2 = -.4;
I3 = -.6;
I4 = -.8;
I5 = -1;
...
By_xp_1 = (-Z.*k_p_1.*(k_1xp_1 - k_2xp_1))*I1*m0;
Bz_xp_1 = (-(a_yp_1-Y).*k_p_1.*(k_1xp_1 - k_2xp_1))*I1*m0;
...
By_xn_1 = (Z.*k_n_1.*(k_1xn_1 - k_2xn_1))*I1*m0;
Bz_xn_1 = ((a_yn_1-Y).*k_n_1.*(k_1xn_1 - k_2xn_1))*I1*m0;
...
By_xn_2 = (Z.*k_n_2.*(k_1xn_2 - k_2xn_2))*I2*m0;
Bz_xn_2 = ((a_yn_2-Y).*k_n_2.*(k_1xn_2 - k_2xn_2))*I2*m0;
...
k_3yp_3 = (y1_3-y)./((y1_3-y)^2+(a_xp_3-X).^2+Z.^2).^0.5;

Bx_yp_3 = -(Z.*k_yp_3.*(k_1yp_3 - k_3yp_3))*I3*m0;
By_yp_3 = m0*zeros(size(X,1),size(Z,1));
Bz_yp_3 = (-(a_xp_1-X).*k_yp_3.*(k_1yp_3 - k_3yp_3))*I3*m0;

k_yn_3 = 1./(4*pi*((a_xn_3-X).^2+Z.^2));
k_1yn_3 = (y2_3-y)./((y2_3-y)^2+(a_xn_3-X).^2+Z.^2).^0.5;
k_3yn_3 = (y1_3-y)./((y1_3-y)^2+(a_xn_3-X).^2+Z.^2).^0.5;

Bx_yn_3 = (Z.*k_yn_3.*(k_1yn_3 - k_3yn_3))*I3*m0;
By_yn_3 = m0*zeros(size(X,1),size(Z,1));
Bz_yn_3 = ((a_xn_3-X).*k_yn_3.*(k_1yn_3 - k_3yn_3))*I3*m0;
...
x1_3 = -0.6e-3;
x2_3 = 0.6e-3;
a_yp_3 = g;          %Distance of coil from (0,0)
x = 0;
coil_length_x_1 = x2_3 - x1_3;
k_p_3 = 1./(4*pi*((a_yp_1-Y).^2+Z.^2));
k_1xp_3 = (x2_3-x)./((x2_3-x).^2+(a_yp_3-Y).^2+Z.^2).^0.5;
k_3xp_3 = (x1_3-x)./((x1_3-x).^2+(a_yp_3-Y).^2+Z.^2).^0.5;

Bx_xp_3 = m0*zeros(size(Y,1),size(Z,1));
By_xp_3 = (-Z.*k_p_3.*(k_1xp_3 - k_3xp_3))*I3*m0;
Bz_xp_3 = (-(a_yp_3-Y).*k_p_3.*(k_1xp_3 - k_3xp_3))*I3*m0;

a_yn_3 = -g;
k_n_3 = 1./(4*pi*((a_yn_3-Y).^2+Z.^2));
k_1xn_3 = (x2_3-x)./((x2_3-x).^2+(a_yn_3-Y).^2+Z.^2).^0.5;
k_3xn_3 = (x1_3-x)./((x1_3-x).^2+(a_yn_3-Y).^2+Z.^2).^0.5;

Bx_xn_3 = m0*zeros(size(Y,1),size(Z,1));
By_xn_3 = (Z.*k_n_3.*(k_1xn_3 - k_3xn_3))*I3*m0;
Bz_xn_3 = ((a_yn_3-Y).*k_n_3.*(k_1xn_3 - k_3xn_3))*I3*m0;
...
k_4yp_4 = (y1_4-y)./((y1_4-y)^2+(a_xp_4-X).^2+Z.^2).^0.5;

Bx_yp_4 = -(Z.*k_yp_4.*(k_1yp_4 - k_4yp_4))*I4*m0;
By_yp_4 = m0*zeros(size(X,1),size(Z,1));
Bz_yp_4 = (-(a_xp_1-X).*k_yp_4.*(k_1yp_4 - k_4yp_4))*I4*m0;

k_yn_4 = 1./(4*pi*((a_xn_4-X).^2+Z.^2));
k_1yn_4 = (y2_4-y)./((y2_4-y)^2+(a_xn_4-X).^2+Z.^2).^0.5;
k_4yn_4 = (y1_4-y)./((y1_4-y)^2+(a_xn_4-X).^2+Z.^2).^0.5;

Bx_yn_4 = (Z.*k_yn_4.*(k_1yn_4 - k_4yn_4))*I4*m0;
By_yn_4 = m0*zeros(size(X,1),size(Z,1));
Bz_yn_4 = ((a_xn_4-X).*k_yn_4.*(k_1yn_4 - k_4yn_4))*I4*m0;
...
x1_4 = -0.6e-3;
x2_4 = 0.6e-3;
a_yp_4 = g;          %Distance of coil from (0,0)
x = 0;
coil_length_x_1 = x2_4 - x1_4;
k_p_4 = 1./(4*pi*((a_yp_1-Y).^2+Z.^2));
k_1xp_4 = (x2_4-x)./((x2_4-x).^2+(a_yp_4-Y).^2+Z.^2).^0.5;
k_4xp_4 = (x1_4-x)./((x1_4-x).^2+(a_yp_4-Y).^2+Z.^2).^0.5;

Bx_xp_4 = m0*zeros(size(Y,1),size(Z,1));
By_xp_4 = (-Z.*k_p_4.*(k_1xp_4 - k_4xp_4))*I4*m0;
Bz_xp_4 = (-(a_yp_4-Y).*k_p_4.*(k_1xp_4 - k_4xp_4))*I4*m0;

a_yn_4 = -g;
k_n_4 = 1./(4*pi*((a_yn_4-Y).^2+Z.^2));
k_1xn_4 = (x2_4-x)./((x2_4-x).^2+(a_yn_4-Y).^2+Z.^2).^0.5;
k_4xn_4 = (x1_4-x)./((x1_4-x).^2+(a_yn_4-Y).^2+Z.^2).^0.5;

Bx_xn_4 = m0*zeros(size(Y,1),size(Z,1));
By_xn_4 = (Z.*k_n_4.*(k_1xn_4 - k_4xn_4))*I4*m0;
Bz_xn_4 = ((a_yn_4-Y).*k_n_4.*(k_1xn_4 - k_4xn_4))*I4*m0;
...
k_5yp_5 = (y1_5-y)./((y1_5-y)^2+(a_xp_5-X).^2+Z.^2).^0.5;

Bx_yp_5 = -(Z.*k_yp_5.*(k_1yp_5 - k_5yp_5))*I5*m0;
By_yp_5 = m0*zeros(size(X,1),size(Z,1));
Bz_yp_5 = (-(a_xp_1-X).*k_yp_5.*(k_1yp_5 - k_5yp_5))*I5*m0;

k_yn_5 = 1./(4*pi*((a_xn_5-X).^2+Z.^2));
k_1yn_5 = (y2_5-y)./((y2_5-y)^2+(a_xn_5-X).^2+Z.^2).^0.5;
k_5yn_5 = (y1_5-y)./((y1_5-y)^2+(a_xn_5-X).^2+Z.^2).^0.5;

Bx_yn_5 = (Z.*k_yn_5.*(k_1yn_5 - k_5yn_5))*I5*m0;
By_yn_5 = m0*zeros(size(X,1),size(Z,1));
Bz_yn_5 = ((a_xn_5-X).*k_yn_5.*(k_1yn_5 - k_5yn_5))*I5*m0;
...
x1_5 = -0.6e-3;
x2_5 = 0.6e-3;
a_yp_5 = g;          %Distance of coil from (0,0)
x = 0;
coil_length_x_1 = x2_5 - x1_5;
k_p_5 = 1./(4*pi*((a_yp_1-Y).^2+Z.^2));
k_1xp_5 = (x2_5-x)./((x2_5-x).^2+(a_yp_5-Y).^2+Z.^2).^0.5;
k_5xp_5 = (x1_5-x)./((x1_5-x).^2+(a_yp_5-Y).^2+Z.^2).^0.5;

Bx_xp_5 = m0*zeros(size(Y,1),size(Z,1));
By_xp_5 = (-Z.*k_p_5.*(k_1xp_5 - k_5xp_5))*I5*m0;
Bz_xp_5 = (-(a_yp_5-Y).*k_p_5.*(k_1xp_5 - k_5xp_5))*I5*m0;

a_yn_5 = -g;
k_n_5 = 1./(4*pi*((a_yn_5-Y).^2+Z.^2));
k_1xn_5 = (x2_5-x)./((x2_5-x).^2+(a_yn_5-Y).^2+Z.^2).^0.5;
k_5xn_5 = (x1_5-x)./((x1_5-x).^2+(a_yn_5-Y).^2+Z.^2).^0.5;

Bx_xn_5 = m0*zeros(size(Y,1),size(Z,1));
By_xn_5 = (Z.*k_n_5.*(k_1xn_5 - k_5xn_5))*I5*m0;
Bz_xn_5 = ((a_yn_5-Y).*k_n_5.*(k_1xn_5 - k_5xn_5))*I5*m0;
...
F_yy_2 = vol_cy * Magentization* (dBy_1_dy + dBy_1_dyn + dBy_1_dy_2 + dBy_1_dy_2n)/m0;
F_yy_3 = vol_cy * Magentization* (dBy_1_dy + dBy_1_dyn + dBy_1_dy_2 + dBy_1_dy_2n + dBy_1_dy_3 + dBy_1_dy_3n)/m0;
F_yy_4 = vol_cy * Magentization* (dBy_1_dy + dBy_1_dyn + dBy_1_dy_2 + dBy_1_dy_2n + dBy_1_dy_3 + dBy_1_dy_3n + dBy_1_dy_4 + dBy_1_dy_4n)/m0;
F_yy_5 = vol_cy * Magentization* (dBy_1_dy + dBy_1_dyn + dBy_1_dy_2 + dBy_1_dy_2n + dBy_1_dy_3 + dBy_1_dy_3n + dBy_1_dy_4 + dBy_1_dy_4n + dBy_1_dy_5 + dBy_1_dy_5n)/m0; 

F_yz_1 = vol_cy * Magentization* (dBy_1_dz + dBy_1_dzn)/m0;
F_yz_2 = vol_cy * Magentization* (dBy_1_dz + dBy_1_dzn + dBy_1_dz_2 + dBy_1_dz_2n)/m0;
F_yz_3 = vol_cy * Magentization* (dBy_1_dz + dBy_1_dzn + dBy_1_dz_2 + dBy_1_dz_2n + dBy_1_dz_3 + dBy_1_dz_3n)/m0;
F_yz_4 = vol_cy * Magentization* (dBy_1_dz + dBy_1_dzn + dBy_1_dz_2 + dBy_1_dz_2n + dBy_1_dz_3 + dBy_1_dz_3n + dBy_1_dz_4 + dBy_1_dz_4n)/m0;
F_yz_5 = vol_cy * Magentization* (dBy_1_dz + dBy_1_dzn + dBy_1_dz_2 + dBy_1_dz_2n + dBy_1_dz_3 + dBy_1_dz_3n + dBy_1_dz_4 + dBy_1_dz_4n + dBy_1_dz_5 + dBy_1_dz_5n)/m0;
...
plot(c*1000,F_xz_2(p,:)*1000,'g')
% plot(c*1000,F_xz_3(p,:)*1000,'-k')
plot(c*1000,F_xz_4(p,:)*1000,'.-b')
% plot(c*1000,F_xz_5(p,:)*1000,':m')
line([-1 1],[Force_cy*1000 Force_cy*1000],'linewidth',1.5,'color','cyan')
line([a_yn_1*1000 a_yn_1*1000],[-1e-2*1000 1e-2*1000],'linewidth',10,'color','g');
line([a_yp_1*1000,a_yp_1*1000],[-1e-2*1000 1e-2*1000],'linewidth',10,'color','g');
legend('I = 0.2A', 'I = 0.4A', 'I = 0.8A', 'Frictional Force')
xlabel("Distance from Center of wire(mm)")
