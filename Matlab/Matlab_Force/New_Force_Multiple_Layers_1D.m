...
%--------%--------%--------%--------%--------%--------%--------%----------
% Multi-Layer: Considering 2 layers and height difference - .3mm
%-%--------%--------%--------%--------%--------%--------%--------%--------
height_from_layer_1 = 108;
height_from_layer_2 = 118;
F_2_layer = F_yz_5(height_from_layer_2,:) + F_yz_5(height_from_layer_1,:);
%--------%--------%--------%--------%--------%--------%--------%----------
% Plotting "Force generated by Field along X - axis (N)"
%-%--------%--------%--------%--------%--------%--------%--------%--------
p = 108;     %also works for a height of 1mm when we put p = 1
figure
...
% plot(c,F_xz_4(p,:),'.-b')
% plot(c,F_xz_5(p,:),':m')
plot(c*1000,F_2_layer*1000,'k')
line([-3e-3*1000 3e-3*1000],[Force_cy*1000 Force_cy*1000],'linewidth',3,'color','cyan')
...
legend('single layer PCB', 'double layer PCB', 'Frictional Force')
